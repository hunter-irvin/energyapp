...
const FIXED_CHUNK_HOURS = 24 * 7;
const resolveV4RtChunkHours = () => FIXED_CHUNK_HOURS;
const resolveV4DaChunkHours = () => FIXED_CHUNK_HOURS;
...
const buildCaisoChunks = ({ start, end, marketMode = "real_time" }) => {
  ...
  const chunkHours = isDayAhead ? resolveV4DaChunkHours() : resolveV4RtChunkHours();
